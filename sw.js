const CACHE='triathlon-karriere-v2.0.0';
const ASSETS=['./','./index.html','./css/styles.css','./js/game-data.js','./js/audio.js','./js/app.js','./manifest.webmanifest','./assets/favicon.svg','./assets/icon-192.png','./assets/icon-512.png'];
